...
if __name__ == '__main__':
    ...
    print("\nWelcome to the program\tcreated by \x1b[31;53;4m'some text'\x1b[0m   ")

    n = int(input("\nEnter the number of names you want to insert : "))
    #creating names list entered by the user to jumbled them \x1b[1;34m \x1b[0;34m  '\x1b[31;43;4msome text\x1b[0m'
